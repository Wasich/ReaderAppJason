...
import com.example.designer2.readerappjason.adapter.VerticalAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private List<Anime> firstAnime;
    private List<Category>firstcategorie;
    private RecyclerView recyclerView,verticalRecyclerview;
    ...
    private void setupverticalrecyclerview(List<Category> firstcategorie){
        VerticalAdapter verticalAdapter = new VerticalAdapter(this,firstcategorie);
